...
class DynamicMiniBatchTransformer(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(self, maxBatchSize=2147483647):
        ...
        self._java_obj = self._new_java_obj("com.microsoft.ml.spark.stages.DynamicMiniBatchTransformer")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.ml.spark.stages.DynamicMiniBatchTransformer"
