...
class FixedMiniBatchTransformer(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(self, batchSize=None, buffered=False, maxBufferSize=2147483647):
        ...
        self._java_obj = self._new_java_obj("com.microsoft.ml.spark.stages.FixedMiniBatchTransformer")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.ml.spark.stages.FixedMiniBatchTransformer"
