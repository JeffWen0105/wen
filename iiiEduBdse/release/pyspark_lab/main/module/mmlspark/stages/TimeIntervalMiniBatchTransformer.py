...
class TimeIntervalMiniBatchTransformer(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(self, maxBatchSize=2147483647, millisToWait=None):
        ...
        self._java_obj = self._new_java_obj("com.microsoft.ml.spark.stages.TimeIntervalMiniBatchTransformer")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.ml.spark.stages.TimeIntervalMiniBatchTransformer"
