...
class _FindBestModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaEstimator):
    ...
    def __init__(self, evaluationMetric="accuracy", models=None):
        ...
        self._java_obj = self._new_java_obj("com.microsoft.ml.spark.automl.FindBestModel")
        self._cache = {}
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.ml.spark.automl.FindBestModel"
...
class _BestModel(ComplexParamsMixin, JavaModel, JavaMLWritable, JavaMLReadable):
    ...
    def getJavaPackage():
        """ Returns package name String. """
        return "com.microsoft.ml.spark.automl.BestModel"
