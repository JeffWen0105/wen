...
class _CNTKModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    Args:
        ...
        miniBatcher (object): Minibatcher to use (default: FixedMiniBatchTransformer_75b5084a9ab8)
    ...
    def __init__(self, batchInput=True, convertOutputToDenseVector=True, feedDict={"ARGUMENT_0":"ARGUMENT_0"}, fetchDict={"OUTPUT_0":"OUTPUT_0"}, miniBatcher=None, model=None, shapeOutput=False):
        ...
        self.miniBatcher = Param(self, "miniBatcher", "miniBatcher: Minibatcher to use (default: FixedMiniBatchTransformer_75b5084a9ab8)", generateTypeConverter("miniBatcher", self._cache, complexTypeConverter))
    ...
    def getMiniBatcher(self):
        ...
        Returns:
            ...
            object: Minibatcher to use (default: FixedMiniBatchTransformer_75b5084a9ab8)
        """
