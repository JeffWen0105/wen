...
class VerifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(self, concurrency=1, concurrentTimeout=100.0, errorCol=None, faceId=None, faceId1=None, faceId2=None, handler=None, largePersonGroupId=None, outputCol=None, personGroupId=None, personId=None, subscriptionKey=None, timeout=60.0, url=None):
        ...
        self._java_obj = self._new_java_obj("com.microsoft.ml.spark.cognitive.VerifyFaces")
        self._cache = {}
        ...
        self.largePersonGroupId = Param(self, "largePersonGroupId", "largePersonGroupId: Using existing largePersonGroupId and personId for fast adding a specified person. largePersonGroupId is created in LargePersonGroup - Create. Parameter personGroupId and largePersonGroupId should not be provided at the same time.")
    ...
    def getLargePersonGroupId(self):
        ...
        Returns:
            ...
            object: Using existing largePersonGroupId and personId for fast adding a specified person. largePersonGroupId is created in LargePersonGroup - Create. Parameter personGroupId and largePersonGroupId should not be provided at the same time.
        """
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.ml.spark.cognitive.VerifyFaces"
