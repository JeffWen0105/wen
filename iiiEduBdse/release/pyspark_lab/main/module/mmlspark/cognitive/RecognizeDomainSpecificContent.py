...
class RecognizeDomainSpecificContent(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    @keyword_only
    def __init__(self, concurrency=1, concurrentTimeout=100.0, errorCol=None, handler=None, imageBytes=None, imageUrl=None, model=None, outputCol=None, subscriptionKey=None, timeout=60.0, url=None):
        super(RecognizeDomainSpecificContent, self).__init__()
        self._java_obj = self._new_java_obj("com.microsoft.ml.spark.cognitive.RecognizeDomainSpecificContent")
        self._cache = {}
        ...
        self.model = Param(self, "model", "model: the domain specific model: celebrities, landmarks")
    ...
    @keyword_only
    def setParams(self, concurrency=1, concurrentTimeout=100.0, errorCol=None, handler=None, imageBytes=None, imageUrl=None, model=None, outputCol=None, subscriptionKey=None, timeout=60.0, url=None):
        """
    ...
    def getModel(self):
        ...
        Returns:
            ...
            object: the domain specific model: celebrities, landmarks
        """
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.ml.spark.cognitive.RecognizeDomainSpecificContent"
