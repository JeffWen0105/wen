...
class GenerateThumbnails(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    @keyword_only
    def __init__(self, concurrency=1, concurrentTimeout=100.0, errorCol=None, handler=None, height=None, imageBytes=None, imageUrl=None, outputCol=None, smartCropping=None, subscriptionKey=None, timeout=60.0, url=None, width=None):
        super(GenerateThumbnails, self).__init__()
        self._java_obj = self._new_java_obj("com.microsoft.ml.spark.cognitive.GenerateThumbnails")
        self._cache = {}
        ...
        self.height = Param(self, "height", "height: the desired height of the image")
        ...
        self.smartCropping = Param(self, "smartCropping", "smartCropping: whether to intelligently crop the image")
        ...
        self.width = Param(self, "width", "width: the desired width of the image")
    ...
    @keyword_only
    def setParams(self, concurrency=1, concurrentTimeout=100.0, errorCol=None, handler=None, height=None, imageBytes=None, imageUrl=None, outputCol=None, smartCropping=None, subscriptionKey=None, timeout=60.0, url=None, width=None):
        """
    ...
    def getHeight(self):
        ...
        Returns:
            ...
            object: the desired height of the image
        """
    ...
    def getSmartCropping(self):
        ...
        Returns:
            ...
            object: whether to intelligently crop the image
        """
        return self._cache.get("smartCropping", None)
    ...
    def getWidth(self):
        ...
        Returns:
            ...
            object: the desired width of the image
        """
