...
class TagImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    @keyword_only
    def __init__(self, concurrency=1, concurrentTimeout=100.0, errorCol=None, handler=None, imageBytes=None, imageUrl=None, language=None, outputCol=None, subscriptionKey=None, timeout=60.0, url=None):
        super(TagImage, self).__init__()
        self._java_obj = self._new_java_obj("com.microsoft.ml.spark.cognitive.TagImage")
        self._cache = {}
        ...
        self.language = Param(self, "language", "language: The desired language for output generation. (default: ServiceParamData(None,Some(en)))")
    ...
    @keyword_only
    def setParams(self, concurrency=1, concurrentTimeout=100.0, errorCol=None, handler=None, imageBytes=None, imageUrl=None, language=None, outputCol=None, subscriptionKey=None, timeout=60.0, url=None):
        """
    ...
    def getLanguage(self):
        ...
        Returns:
            ...
            object: The desired language for output generation. (default: ServiceParamData(None,Some(en)))
        """
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.ml.spark.cognitive.TagImage"
