...
class _LightGBMRanker(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaEstimator):
    ...
    Args:
        ...
        evalAt (list): NDCG and MAP evaluation positions, separated by comma (default: [I@58e5bb5d)
        ...
        labelGain (list): parameter for Huber loss and Quantile regression (default: [D@309aa4dd)
    ...
    def __init__(self, baggingFraction=1.0, baggingFreq=0, baggingSeed=3, boostFromAverage=True, boostingType="gbdt", categoricalSlotIndexes=None, categoricalSlotNames=None, defaultListenPort=12400, earlyStoppingRound=0, evalAt=[1,2,3,4,5], featureFraction=1.0, featuresCol="features", groupCol=None, initScoreCol=None, isProvideTrainingMetric=False, labelCol="label", labelGain=[], lambdaL1=0.0, lambdaL2=0.0, learningRate=0.1, maxBin=255, maxDepth=-1, maxPosition=20, metric="", minSumHessianInLeaf=0.001, modelString="", numBatches=0, numIterations=100, numLeaves=31, objective="lambdarank", parallelism="data_parallel", predictionCol="prediction", timeout=1200.0, useBarrierExecutionMode=False, validationIndicatorCol=None, verbosity=1, weightCol=None):
        ...
        self.evalAt = Param(self, "evalAt", "evalAt: NDCG and MAP evaluation positions, separated by comma (default: [I@58e5bb5d)")
        ...
        self.labelGain = Param(self, "labelGain", "labelGain: parameter for Huber loss and Quantile regression (default: [D@309aa4dd)")
    ...
    @keyword_only
    def setParams(self, baggingFraction=1.0, baggingFreq=0, baggingSeed=3, boostFromAverage=True, boostingType="gbdt", categoricalSlotIndexes=None, categoricalSlotNames=None, defaultListenPort=12400, earlyStoppingRound=0, evalAt=[1,2,3,4,5], featureFraction=1.0, featuresCol="features", groupCol=None, initScoreCol=None, isProvideTrainingMetric=False, labelCol="label", labelGain=[], lambdaL1=0.0, lambdaL2=0.0, learningRate=0.1, maxBin=255, maxDepth=-1, maxPosition=20, metric="", minSumHessianInLeaf=0.001, modelString="", numBatches=0, numIterations=100, numLeaves=31, objective="lambdarank", parallelism="data_parallel", predictionCol="prediction", timeout=1200.0, useBarrierExecutionMode=False, validationIndicatorCol=None, verbosity=1, weightCol=None):
        """
    ...
    def getEvalAt(self):
        ...
        Returns:
            ...
            list: NDCG and MAP evaluation positions, separated by comma (default: [I@58e5bb5d)
        """
    ...
    def getLabelGain(self):
        ...
        Returns:
            ...
            list: parameter for Huber loss and Quantile regression (default: [D@309aa4dd)
        """
