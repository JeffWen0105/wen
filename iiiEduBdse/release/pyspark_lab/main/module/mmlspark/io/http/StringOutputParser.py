...
class StringOutputParser(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(self, inputCol=None, outputCol=None):
        super(StringOutputParser, self).__init__()
        self._java_obj = self._new_java_obj("com.microsoft.ml.spark.io.http.StringOutputParser")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.ml.spark.io.http.StringOutputParser"

    @staticmethod
    def _from_java(java_stage):
        module_name=StringOutputParser.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".StringOutputParser"
