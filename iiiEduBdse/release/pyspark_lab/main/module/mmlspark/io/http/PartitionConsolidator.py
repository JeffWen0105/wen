...
class PartitionConsolidator(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    @keyword_only
    def __init__(self, concurrency=1, concurrentTimeout=100.0, inputCol=None, outputCol=None, timeout=60.0):
        super(PartitionConsolidator, self).__init__()
        self._java_obj = self._new_java_obj("com.microsoft.ml.spark.io.http.PartitionConsolidator")
    ...
    @keyword_only
    def setParams(self, concurrency=1, concurrentTimeout=100.0, inputCol=None, outputCol=None, timeout=60.0):
        """
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.ml.spark.io.http.PartitionConsolidator"
