...
class CustomInputParser(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(self, inputCol=None, outputCol=None, udfPython=None, udfScala=None):
        super(CustomInputParser, self).__init__()
        self._java_obj = self._new_java_obj("com.microsoft.ml.spark.io.http.CustomInputParser")
        self._cache = {}
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.ml.spark.io.http.CustomInputParser"

    @staticmethod
    def _from_java(java_stage):
        module_name=CustomInputParser.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".CustomInputParser"
