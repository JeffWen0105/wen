...
class _SimpleHTTPTransformer(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    Args:
        ...
        inputParser (object): format to parse the column to (default: JSONInputParser_f3efffc5f111)
    ...
    def __init__(self, concurrency=1, concurrentTimeout=100.0, errorCol=None, flattenOutputBatches=None, handler=None, inputCol=None, inputParser=None, miniBatcher=None, outputCol=None, outputParser=None, timeout=60.0):
        ...
        self.inputParser = Param(self, "inputParser", "inputParser: format to parse the column to (default: JSONInputParser_f3efffc5f111)", generateTypeConverter("inputParser", self._cache, complexTypeConverter))
    ...
    def getInputParser(self):
        ...
        Returns:
            ...
            object: format to parse the column to (default: JSONInputParser_f3efffc5f111)
        """
